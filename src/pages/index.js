      ...
      <section className="section has-background-light">
        <div className="container">
          ...
          <div className="mb-6">
            ...
            <div className="columns is-multiline is-centered">
              <div className="column is-3">
                <div className="box has-text-centered" style={{ minHeight: '150px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: 'white' }} aria-hidden="true">
                  <p className="has-text-grey-light">Your Logo Here</p>
                </div>
              </div>
              <div className="column is-3">
                <div className="box has-text-centered" style={{ minHeight: '150px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: 'white' }} aria-hidden="true">
          ...
          <div className="mb-6">
            ...
            <div className="columns is-multiline is-centered">
              <div className="column is-3">
                <div className="box has-text-centered" style={{ minHeight: '120px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: 'white' }} aria-hidden="true">
                  <p className="has-text-grey-light has-text-weight-light">Your Logo Here</p>
                </div>
              </div>
              <div className="column is-3">
                <div className="box has-text-centered" style={{ minHeight: '120px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: 'white' }} aria-hidden="true">
